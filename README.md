...
What is this?
Basicly, this is Minecraft modification with goal to make easier updates to your modpack. Your friends / players won't need to manually update all mods / modpack anymore, thanks to this mod all this boring stuff is done automatically.
