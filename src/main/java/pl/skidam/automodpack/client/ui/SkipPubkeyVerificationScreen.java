...
public class SkipPubkeyVerificationScreen extends VersionedScreen {
    ...
    public SkipPubkeyVerificationScreen(Screen verificationScreen, Screen parent, Runnable validatedCallback) {
        super(VersionedText.literal("SkipPubkeyVerificationScreen"));
