...
public class RestartScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 50 - 100, this.height / 6 + 48 - 6 + 75, 150, 20, Text.translatable("gui.automodpack.screen.restart.button.cancel").formatted(Formatting.GREEN), (button) -> this.client.setScreen(parent)));
        this.addDrawableChild(new ButtonWidget(this.width / 2, this.height / 6 + 48 - 6 + 75, 150, 20, Text.translatable("gui.automodpack.screen.restart.button.quit").formatted(Formatting.RED), (button) -> this.client.scheduleStop()));
    }
