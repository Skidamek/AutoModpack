...
public class FetchScreen extends VersionedScreen {
	...
	private void initWidgets() {
		cancelButton = buttonWidget(this.width / 2 - 60, this.height / 2 + 80, 120, 20, VersionedText.translatable("automodpack.cancel"), button -> {
	...
	public void versionedRender(VersionedMatrices matrices, int mouseX, int mouseY, float delta) {
		...
		// Please wait message
		drawCenteredTextWithShadow(matrices, this.font, VersionedText.translatable("automodpack.wait"), this.width / 2, this.height / 2 - 60 + lineHeight * 2,
				TextColors.WHITE);

		// Found count
		drawCenteredTextWithShadow(matrices, this.font, VersionedText.translatable("automodpack.fetch.found", getFetchesDone()), this.width / 2,
