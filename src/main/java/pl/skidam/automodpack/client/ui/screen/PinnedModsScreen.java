...
public final class PinnedModsScreen extends VersionedScreen {
	...
	protected void init() {
		...
		RowListWidget list = new RowListWidget(this.minecraft, this.width, this.height, width, 0, LIST_TOP, listBottom, ROW_HEIGHT, listRows, index -> toggle(rows.get(index)));
