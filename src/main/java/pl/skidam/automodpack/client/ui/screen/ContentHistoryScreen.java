...
public final class ContentHistoryScreen extends VersionedScreen {
	...
	protected void init() {
		...
		this.addRenderableWidget(new RowListWidget(this.minecraft, this.width, this.height, width, 0, LIST_TOP, listBottom, ROW_HEIGHT, rows, this::openEntry, this::showComponentTooltip));
