...
public class ClientLoginNetworking {
	...
	public interface LoginQueryRequestHandler {
		 ...
		 *
		 * <p>
		 * The return value of this method is a completable future that may be used to delay the login process to the server until a task
		 * {@link CompletableFuture#isDone() is done}.
