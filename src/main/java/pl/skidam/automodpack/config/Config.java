...
public class Config {
    ...
    public static boolean OPTIONAL_MODPACK;
    ...
    static {
        ...
        OPTIONAL_MODPACK = getBoolean(properties, "optional_modpack", false);
    ...
    public void save() {
        ...
        properties.setProperty("optional_modpack", String.valueOf(OPTIONAL_MODPACK));
