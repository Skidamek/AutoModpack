...
is regenerated; when nothing needs it anymore, it disappears. Don't edit or rename it:
deleting it is safe (it comes back), but renaming it leaves a stray duplicate that will
be cleaned up on the next repair.
