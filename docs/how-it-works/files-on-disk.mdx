...
| Path | Role |
| --- | --- |
| `server-config.hconf` | [Server settings](../configuration/server-config) |
| `client-config.hconf` | [Client settings](../configuration/client-config) |
...
| `host-modpack/music.ogg` | Optional custom waiting track, streamed to clients during downloads |
