...
| `selfUpdater`                   | `false`          | Turn on/off automodpack self-updates. This does not affect the mod's activity in installing modpacks. This does not disable AutoModpack version syncing with server |
