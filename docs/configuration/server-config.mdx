...
| modpackName                 | `""`            | The display name of the modpack shown during download. This also determines the folder name inside `~/automodpack/modpacks/`. |
...
| Setting               | Default | Description                                                                                            |
|-----------------------|---------|--------------------------------------------------------------------------------------------------------|
| bindAddress           | `""`    | The local IP to bind the host to. Empty binds to 0.0.0.0 (all). Ignored if bindPort is -1.             |
