...
However, please do not think of it like a password to the modpack, it's not a password or any secret, it's a public verifiable piece of server certificate, **anyone could download** your modpack without previous knowledge of such fingerprint.
...
### Wait but why do I need all this? It's just a modpack for my friends!
...
That's why we believe it's important to have some security measures.
