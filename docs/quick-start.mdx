...
> **Pro Tip:** It is recommended to connect to your server with just AutoModpack installed on the client first to ensure everything works.
...
> **Note:** The client config file (`~/automodpack/automodpack-client.json`) is managed automatically. You normally don't need to edit it manually. For advanced configuration, see the [client config page](configuration/client-config).
