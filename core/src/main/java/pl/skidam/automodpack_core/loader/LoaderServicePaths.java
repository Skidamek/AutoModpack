...
public final class LoaderServicePaths {
    ...
    public static final Set<String> FORGE_SERVICES = Set.of(
            FORGE_MOD_LOCATOR, FORGE_DEPENDENCY_LOCATOR, FORGE_LANGUAGE_PROVIDER, TRANSFORMATION_SERVICE);

    // Broad, cross-version set of NeoForge service files, same purpose as FORGE_SERVICES.
    public static final Set<String> NEOFORGE_SERVICES = Set.of(
            NEOFORGE_MOD_LOCATOR, NEOFORGE_DEPENDENCY_LOCATOR, NEOFORGE_MOD_FILE_READER,
            NEOFORGE_LANGUAGE_LOADER, NEOFORGE_CANDIDATE_LOCATOR, NEOFORGE_GRAPHICS_BOOTSTRAPPER,
    ...
    public static final Set<String> ALL_SERVICES = Stream.concat(FORGE_SERVICES.stream(), NEOFORGE_SERVICES.stream())
