...
class DurableGsonTypesTest {
	...
	void gsonFacingTypesAreNotRecords() throws IOException {
		...
		for (Class<?> type : List.of(UpdateTransaction.class, ClientConfigJsons.ClientConfigFieldsV3.class, ServerConfigJsons.ServerConfigFieldsV3.class, AuthJsons.SecretsFields.class,
				...
				ModpackJsons.ModpackContentFields.class, StorageJsons.ObjectOwnershipFields.class, StorageJsons.SelfUpdateFields.class, ClientStorageJsons.ClientBaselineFields.class,
				ClientStorageJsons.ClientGeneratedCopiesFields.class, ClientStorageJsons.ClientGenerationStateFields.class, ClientStorageJsons.ClientPreservationVaultFields.class,
				ClientStorageJsons.ClientOverlayFields.class, ClientStorageJsons.ClientCompactionReceiptFields.class, ClientStorageJsons.OfflineRepairJournalFields.class, FileCache.CachedFile.class,
