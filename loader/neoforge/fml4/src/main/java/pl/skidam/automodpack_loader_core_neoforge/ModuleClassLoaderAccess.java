...
/**
 * Reads the two private routing maps of a {@link ModuleClassLoader} (and its subclasses, such as
 ...
 * </ul>
 * Adding a {@code parentLoaders} entry is exactly the package-to-loader delegation FML itself sets up
 * for a real SERVICE-layer mod; the maps are mutable and never swapped after construction, so we only
 * mutate their contents, never the fields.
 *
